...
echo "2. Connect via telnet: telnet localhost 5000"
echo "3. Log in: :SYS,LBE"
echo "4. Transfer files using one of:"
echo ""
echo "   Option A: Manual copy from host"
echo "   - Use your host OS to copy files"
echo "   - Paste into CP-V editor"
echo ""
echo "   Option B: Create tape image (advanced)"
echo "   - Use simh tape utilities"
echo "   - Mount in emulator"
echo ""
echo "See emulator/CPV_DEPLOYMENT.md for complete instructions"
echo ""
